...
{
cout << n << " is blum number: " << n << " = " << i << "*" << n / i << endl;
count++;
}
}
if (count == 1) cout << n << " IT IS NOT BLUM NUMBER!" << endl;
return count;
}
...
int main() {
    ...
    cout << "Enter number M: ";
    cin >> M;
    if (checkBlumNumber(blumNumbers, M)) cout << M << " It's blum number." << endl;
    else cout << M << " IT IS NOT BLUM NUMBER!" << endl;
    return 0;
}